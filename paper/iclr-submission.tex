...
% ---- Tight float spacing: use paragraph spacing when available ----
\makeatletter
\ifdim\parskip>0pt
  \setlength{\intextsep}{\parskip}% space around in-text floats
  \setlength{\textfloatsep}{\parskip}% space above/below top/bottom floats
  \setlength{\floatsep}{.5\parskip}% between floats
  \setlength{\dbltextfloatsep}{\parskip}% two-column top/bottom
  \setlength{\dblfloatsep}{.5\parskip}% between dbl floats
\else
  \setlength{\intextsep}{6pt plus 2pt minus 2pt}% fallback if \parskip=0pt
...
% ------------------------------------------------------------------
\begin{document}
\raggedbottom  % reduce large bottom whitespace from page equalization
