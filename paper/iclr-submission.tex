...
We evaluate two open-weight inference regimes compatible with an 8$\times$L4 cluster:
\textbf{(S)} \emph{Llama-3.1-8B-Instruct} and
\textbf{(M)} \emph{Mixtral-8$\times$7B-Instruct} (active params $\approx$13B).
